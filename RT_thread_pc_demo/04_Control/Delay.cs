...
namespace RT_thread_pc_demo._04_Control
{
    public partial class Delay : UserControl
    {
        ...
        private void BtnSwitch_delay_Click(object sender, EventArgs e)
        {
            Comm_Process comm = new Comm_Process();
            Button button = (Button)sender;
            PublicVar.g_TextBox = this.textBox_delay;
            ...
            else
            {
                ...
                {
                    string a = "开始实验";
                    send_command(ref PublicVar.delay_enable, ref a);
                ...
                {
                    string b = "结束实验";
                    send_command(ref PublicVar.delay_close, ref b);
